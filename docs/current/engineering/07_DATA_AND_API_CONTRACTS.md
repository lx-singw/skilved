...
Implementation update, 25 September 2026: the [canonical opportunity contract](14_CANONICAL_OPPORTUNITY_CONTRACT.md) is the implemented B02 authority for opportunity schema, provenance/projection, API query/response, storage, aliases and legacy conversion. It supersedes conflicting illustrative opportunity shapes below; private workspace and later-feature contracts remain proposals. Pure contracts do not establish live endpoints or persistence. [Current candidate verification](../quality/evidence/m0/2026-09-25-b02-contracts/README.md) records scoped results and pending acceptance.
